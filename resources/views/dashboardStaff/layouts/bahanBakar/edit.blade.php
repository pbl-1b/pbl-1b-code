...
<div class="bg-white rounded-md shadow-sm shadow-blue-100 border border-gray-300 p-6 mb-6">
    ...
    <form id="form-id" method="POST" action="{{ route('bahanBakar.update', ['id' => $oldData->id]) }}">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" id="emission" name="emission" value="{{ $oldData->emisi_karbon_permenit }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500"
