...
@section('title', 'Update Data Company Employees Commute')
...
<div class="bg-white rounded-md shadow-sm shadow-blue-100 border border-gray-300 p-6 mb-6">
    ...
    <form id="form-id" class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4" action="{{ route('perjalananKaryawanPerusahaan.update') }}">
        @csrf
        @method('PUT')
        <!-- Employee Name -->
        <div>
