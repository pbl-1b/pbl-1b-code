        ...
        <div class="flex items-center">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3 flex flex-col leading-tight">
                    <span class="text-xl font-bold text-green-800">CompCarbon</span> <!-- Text besar -->
                    <span class="text-sm text-green-800 -mt-2 font-semibold">Naima Sustainability</span> <!-- Text kecil -->
                </div>
            </div>
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="relative hidden md:block">
                ...
                <input 
                    type="text" 
                    placeholder="Search..." 
                    class="w-64 rounded-md bg-gray-100 py-2 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:bg-white border border-gray-300"
                >
            </div>
            ...
            <button class="relative p-2 rounded-md text-gray-600 hover:bg-gray-100">
                ...
                <span class="absolute top-0 right-0 h-5 w-5 flex items-center justify-center text-xs text-white bg-green-500 rounded-md">
                    3
                </span>
            </button>
