<div x-show="isMobileMenuOpen" class="fixed inset-0 z-50 md:hidden" x-cloak>
    <div class="fixed inset-0 bg-black/30" @click="isMobileMenuOpen = false"></div>
    <div class="fixed top-0 left-0 h-full w-64 bg-white shadow-lg">
        <div class="flex items-center justify-between h-16 px-4 border-b border-gray-300">
            <div class="flex items-center">
                ...
                <span class="ml-2 text-xl font-semibold text-green-700">EmpCarbon</span>
            </div>
            <button @click="isMobileMenuOpen = false" class="p-2 rounded-md text-gray-600 hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
            </button>
        </div>
        <nav class="p-4 h-[calc(100%-4rem)] overflow-y-auto custom-scrollbar-green">
            <ul class="space-y-2">
                <li>
                ...
                <li>
                    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-green-50 text-gray-700 border border-transparent">
                        ...
                        <span class="ml-auto bg-green-500 text-white text-xs px-2 py-0.5 rounded-md">New</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-green-50 text-gray-700 border border-transparent">
